...
/// <summary>
/// Codex round 11 (PR #379, feat/gantt-v3) - 3 P2 findings, all in GanttChart's
...
/// tests live in GanttScaleTests.cs; this file covers the full GanttChart
...
public class GanttV3CodexRound11Tests : IAsyncLifetime
{
    ...
    // ── GanttChart: one capture, one recenter for combined changes (P2 #1) ──────

    [Fact]
    public void GanttChart_Recenters_Once_Using_Consistent_Geometry_When_ViewMode_And_ShowTreePane_Change_Together()
    {
    ...
    [Fact]
    public void GanttChart_Still_Recenters_When_Only_ShowTreePane_Changes_Without_A_ViewMode_Change()
    {
    ...
    // ── GanttChart: sub-day ranges align to their unit boundary (P2 #2) ─────────

    [Fact]
    public void GanttChart_Aligns_The_New_Range_To_A_Six_Hour_Boundary_When_Switching_To_QuarterDay_With_A_Sub_Hour_Center()
    {
        ...
        // Ground truth: replicate GanttChart's own pipeline (align center ->
    ...
    // ── GanttChart: populated -> empty must recenter too (P2 #3) ────────────────

    [Fact]
    public void GanttChart_Requests_A_Recenter_When_The_Task_List_Becomes_Empty()
    {
    ...
    [Fact]
    public void GanttChart_Does_Not_Recenter_When_A_Non_Empty_Task_List_Is_Merely_Replaced()
    {
