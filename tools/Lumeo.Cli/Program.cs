...
namespace Lumeo.Cli
{
    ...
    internal sealed class RegistryEntry
    {
        ...
        /// <summary>External NuGet packages the vendored source references. Without these
        /// the vendored .razor will not compile, so <c>add</c> installs them alongside the
        /// component. (Icons are first-party — Lumeo components declare no external icon dep.)</summary>
