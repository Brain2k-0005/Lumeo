...
/// the plan's deliverables end-to-end through <c>GanttChart</c> (parameter
...
public class GanttV3Phase3T6Tests : IAsyncLifetime
{
    ...
    {
        // Component-level defensive guard (GanttChart.HandleRowSelectionChangeAsync)
    ...
    // ── Reorder commit pipeline (GanttChart.HandleRowReorderAsync) ───────────────
    ...
    {
        // Component-level defensive guard (GanttChart.HandleRowReorderAsync)
        ...
        var method = typeof(L.GanttChart).GetMethod("HandleRowReorderAsync", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)!;
