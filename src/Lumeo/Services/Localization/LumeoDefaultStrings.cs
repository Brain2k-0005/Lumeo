...
internal static partial class LumeoDefaultStrings
{
    internal static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["DataGrid.ColumnMenu"] = "Column menu",
        ["DataGrid.SortAscending"] = "Sort ascending",
        ["DataGrid.SortDescending"] = "Sort descending",
        ["DataGrid.FitToContent"] = "Fit to content",
        ["DataGrid.MoveLeft"] = "Move left",
        ["DataGrid.MoveRight"] = "Move right",
        ["DataGrid.ResizeColumn"] = "Resize column (use arrow keys, double-click to auto-fit)",
        ["DataGrid.DragToReorder"] = "Drag to reorder column",
        ["DataGrid.ColumnMovedAnnouncement"] = "{0} moved to position {1} of {2}",
        ["DataGrid.FilterColumn"] = "Filter {0}",
        ["DataGrid.SelectRow"] = "Select row {0}",
        ["DataGrid.SelectAllRows"] = "Select all rows",
        ["DataGrid.ExpandRow"] = "Expand row {0}",
        ["DataGrid.CollapseRow"] = "Collapse row {0}",
        ["DataGrid.ExpandGroup"] = "Expand group {0}",
        ["DataGrid.CollapseGroup"] = "Collapse group {0}",
        ["DataGrid.Hide"] = "Hide",
        ["DataGrid.Show"] = "Show",
        ["DataGrid.SortAscending"] = "Sort ascending",
        ["DataGrid.SortDescending"] = "Sort descending",
        ...
        ["Scheduler.Calendars"] = "Calendars",
        ["Scheduler.NewEvent"] = "New event",
        ["Scheduler.EditEvent"] = "Edit event",
        ["Scheduler.EventTitle"] = "Title",
        ["Scheduler.Starts"] = "Starts",
        ["Scheduler.Ends"] = "Ends",
        ["Scheduler.NoCalendar"] = "No calendar",
        ["Scheduler.Save"] = "Save",
        ["Scheduler.Cancel"] = "Cancel",
        ["Scheduler.Delete"] = "Delete",
        ["Scheduler.MergePanes"] = "Merge panes",
        ["Scheduler.SplitPanes"] = "Side by side",
        ["Scheduler.ToggleCalendar"] = "Show or hide {0}",
        ["Scheduler.NDays"] = "{0} days",
        ...
        ["Scheduler.Announce.ResizeRejected"] = "{0} could not be resized",
        ["Scheduler.List"] = "List",
    ...
    internal static readonly IReadOnlyDictionary<string, string> De = new Dictionary<string, string>
    {
        ...
        ["DataGrid.ColumnMenu"] = "Spaltenmenü",
        ["DataGrid.SortAscending"] = "Aufsteigend sortieren",
        ["DataGrid.SortDescending"] = "Absteigend sortieren",
        ["DataGrid.FitToContent"] = "An Inhalt anpassen",
        ["DataGrid.MoveLeft"] = "Nach links verschieben",
        ["DataGrid.MoveRight"] = "Nach rechts verschieben",
        ...
        ["DataGrid.ColumnMovedAnnouncement"] = "{0} an Position {1} von {2} verschoben",
        ["DataGrid.FilterColumn"] = "{0} filtern",
        ["DataGrid.SelectRow"] = "Zeile {0} auswählen",
        ["DataGrid.SelectAllRows"] = "Alle Zeilen auswählen",
        ["DataGrid.ExpandRow"] = "Zeile {0} ausklappen",
        ["DataGrid.CollapseRow"] = "Zeile {0} einklappen",
        ["DataGrid.ExpandGroup"] = "Gruppe {0} ausklappen",
        ["DataGrid.CollapseGroup"] = "Gruppe {0} einklappen",
        ...
        ["Scheduler.Resources"] = "Ressourcen",
        ["Scheduler.Timeline"] = "Zeitleiste",
        ["Scheduler.Calendars"] = "Kalender",
        ["Scheduler.NewEvent"] = "Neuer Termin",
        ["Scheduler.EditEvent"] = "Termin bearbeiten",
        ["Scheduler.EventTitle"] = "Titel",
        ["Scheduler.Starts"] = "Beginn",
        ["Scheduler.Ends"] = "Ende",
        ["Scheduler.NoCalendar"] = "Kein Kalender",
        ["Scheduler.Save"] = "Speichern",
        ["Scheduler.Cancel"] = "Abbrechen",
        ["Scheduler.Delete"] = "Löschen",
        ["Scheduler.MergePanes"] = "Bereiche zusammenführen",
        ["Scheduler.SplitPanes"] = "Nebeneinander",
        ["Scheduler.ToggleCalendar"] = "{0} ein- oder ausblenden",
        ["Scheduler.NDays"] = "{0} Tage",
        ...
        ["Scheduler.Announce.ResizeRejected"] = "{0} konnte nicht in der Dauer geändert werden",
