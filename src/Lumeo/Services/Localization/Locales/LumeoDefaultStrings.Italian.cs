...
internal static partial class LumeoDefaultStrings
{
    internal static readonly IReadOnlyDictionary<string, string> It = new Dictionary<string, string>
    {
        ...
        ["DataGrid.NoDataFiltered"] = "Nessuna riga corrisponde ai filtri attuali",
        ...
        ["DataGrid.AutoSizeAllColumns"] = "Adatta automaticamente tutte le colonne",
        ...
        ["Flow.CanvasLabel"] = "Area di flusso",
        ["Flow.NodeRole"] = "nodo",
        ["Flow.Controls"] = "Controlli dell'area",
        ["Flow.ZoomIn"] = "Aumenta zoom",
        ["Flow.ZoomOut"] = "Riduci zoom",
        ["Flow.FitView"] = "Adatta alla vista",
        ...
        ["Flow.SnapToGrid"] = "Aggancia alla griglia",
        ["Flow.Undo"] = "Annulla",
        ["Flow.Redo"] = "Ripeti",
        ["Flow.ReconnectHandle"] = "Sposta l'estremità del collegamento",
        ["Flow.ConnectingFrom"] = "Connessione da {0}. Premi Invio su un punto di destinazione per connettere, Esc per annullare.",
        ["Flow.Connected"] = "Connesso.",
        ["Flow.ConnectionRejected"] = "Connessione rifiutata.",
        ["Flow.ConnectionCancelled"] = "Connessione annullata.",
        ["Flow.Reconnected"] = "Collegamento riconnesso.",
        ["Flow.ReconnectRejected"] = "Riconnessione rifiutata.",
        ["Flow.EdgeLabelEdit"] = "Modifica etichetta del collegamento",
        ["Flow.EdgeLabelUpdated"] = "Etichetta aggiornata.",
        ["Flow.GroupDefaultLabel"] = "Gruppo",
        ["Flow.GroupRole"] = "gruppo",
        ["Flow.GroupChildCountOne"] = "1 nodo",
        ["Flow.GroupChildCount"] = "{0} nodi",
        ["Flow.Grouped"] = "{0} nodi raggruppati.",
        ["Flow.Ungrouped"] = "{0} nodi separati dal gruppo.",
...
["Filters.RowLevel"] = "{0}, livello {1}",
        ...
        // QueryBuilder
        ["QueryBuilder.SelectField"] = "Seleziona campo…",
        ["QueryBuilder.SelectPlaceholder"] = "Seleziona…",
    };
}
