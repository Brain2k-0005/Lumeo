...
const guides = [
    ...
    { label: 'Vendor a Component',    href: 'docs/guides/vendor-a-component' },
    { label: 'Customize a Component', href: 'docs/guides/customize-a-component' },
    { label: 'Go Standalone (Eject)', href: 'docs/guides/go-standalone' },
    { label: 'Built with Lumeo (Showcase)', href: 'showcase' },
    { label: 'Northlight - SaaS demo', href: 'demos/saas' },
    { label: 'Meridian Ops - enterprise demo', href: 'demos/enterprise' },
