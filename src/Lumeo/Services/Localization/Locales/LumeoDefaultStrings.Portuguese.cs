...
internal static partial class LumeoDefaultStrings
{
    internal static readonly IReadOnlyDictionary<string, string> Pt = new Dictionary<string, string>
    {
        ...
        ["DataGrid.NoDataFiltered"] = "Nenhuma linha corresponde aos filtros atuais",
        ...
        ["DataGrid.AutoSizeAllColumns"] = "Ajustar automaticamente todas as colunas",
        ...
        ["Flow.CanvasLabel"] = "Tela de fluxo",
        ["Flow.NodeRole"] = "nó",
        ["Flow.Controls"] = "Controles da tela",
        ["Flow.ZoomIn"] = "Ampliar",
        ["Flow.ZoomOut"] = "Reduzir",
        ["Flow.FitView"] = "Ajustar à vista",
        ["Flow.Lock"] = "Bloquear tela",
        ["Flow.ConnectFrom"] = "Conectar de {0}",
        ["Flow.ConnectTo"] = "Conectar a {0}",
        ["Flow.MiniMap"] = "Visão geral",
        ["Flow.NodeToolbar"] = "Ações do nó",
        ["Flow.SnapToGrid"] = "Ajustar à grade",
        ["Flow.Undo"] = "Desfazer",
        ["Flow.Redo"] = "Refazer",
        ["Flow.ReconnectHandle"] = "Mover extremidade da aresta",
        ["Flow.ConnectingFrom"] = "Conectando a partir de {0}. Pressione Enter em uma alça de destino para conectar, Esc para cancelar.",
        ["Flow.Connected"] = "Conectado.",
        ["Flow.ConnectionRejected"] = "Conexão rejeitada.",
        ["Flow.ConnectionCancelled"] = "Conexão cancelada.",
        ["Flow.Reconnected"] = "Aresta reconectada.",
        ["Flow.ReconnectRejected"] = "Reconexão rejeitada.",
        ["Flow.EdgeLabelEdit"] = "Editar rótulo da aresta",
        ["Flow.EdgeLabelUpdated"] = "Rótulo atualizado.",
        ["Flow.GroupDefaultLabel"] = "Grupo",
        ["Flow.GroupRole"] = "grupo",
        ["Flow.GroupChildCountOne"] = "1 nó",
        ["Flow.GroupChildCount"] = "{0} nós",
        ["Flow.Grouped"] = "{0} nós agrupados.",
        ["Flow.Ungrouped"] = "{0} nós desagrupados.",
...
["Filters.RowLevel"] = "{0}, nível {1}",
        ...
        ["Filters.DateFrom"] = "De",
        ["Filters.DateTo"] = "Até",
        ["Filters.DatePlaceholder"] = "hoje, daqui a 1 semana, 01/05/2024...",
        ...
        // QueryBuilder
        ["QueryBuilder.SelectField"] = "Selecionar campo…",
        ["QueryBuilder.SelectPlaceholder"] = "Selecionar…",
    };
}
