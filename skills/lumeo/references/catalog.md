...
- **Scheduler** **[Scheduler]** — Calendar/agenda scheduler wrapping FullCalendar. _(sub-components: SchedulerAgendaView, SchedulerMonthView, SchedulerResourceView, SchedulerTimeGridView, SchedulerTimelineView, SchedulerToolbar)_
