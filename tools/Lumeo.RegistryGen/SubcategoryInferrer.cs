...
public static class SubcategoryInferrer
{
    private static readonly Dictionary<string, string> FormsMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["IconButton"] = "Buttons & Actions",
        ["ButtonGroup"] = "Buttons & Actions",
        ["ToggleButton"] = "Buttons & Actions",
        ["Toggle"] = "Buttons & Actions",

        ["Form"] = "Form Composition",
        ["FormField"] = "Form Composition",
        ["Label"] = "Form Composition",
        ["FieldDescription"] = "Form Composition",
        ["FieldError"] = "Form Composition",
        ["Fieldset"] = "Form Composition",

        ["Slider"] = "Specialized",
        ["Switch"] = "Specialized",
        ["Rating"] = "Specialized",
        ["ColorPicker"] = "Specialized",
        ["DatePicker"] = "Specialized",
        ["TimePicker"] = "Specialized",
        ["DateTimePicker"] = "Specialized",
        ["RangePicker"] = "Specialized",
        ["FileUpload"] = "Specialized",
        ["InplaceEditor"] = "Specialized",
        ["Checkbox"] = "Specialized",
    ...
    private static readonly Dictionary<string, string> DataDisplayMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["StatsCard"] = "Cards & Layout",
        ["Avatar"] = "Cards & Layout",
        ["AvatarGroup"] = "Cards & Layout",
        ["Badge"] = "Cards & Layout",
        ["Descriptions"] = "Cards & Layout",
        ["Image"] = "Cards & Layout",
        ["ImageCompare"] = "Cards & Layout",
        ["Watermark"] = "Cards & Layout",

        ["List"] = "Lists & Trees",
        ["Tree"] = "Lists & Trees",
        ["Timeline"] = "Lists & Trees",
        ["Steps"] = "Lists & Trees",
        ["Carousel"] = "Lists & Trees",
        ["Calendar"] = "Lists & Trees",
        ...
        ["Skeleton"] = "Status & Indicators",
        ["Spinner"] = "Status & Indicators",
        ["Chip"] = "Status & Indicators",
        ["Tag"] = "Status & Indicators",
        ["Delta"] = "Status & Indicators",
        ["Statistic"] = "Status & Indicators",
        ["QRCode"] = "Status & Indicators",
