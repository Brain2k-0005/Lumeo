...
/// directly in GanttChart.razor's own OnParametersSetAsync/
...
public class GanttV3CodexRound13Tests : IAsyncLifetime
{
    ...
    [Fact]
    public void GanttChart_Recenters_Preserving_The_Center_When_ColumnWidth_Changes_Alone()
    {
    ...
    [Fact]
    public void GanttChart_Recenters_Preserving_The_Center_When_ColumnWidth_And_ViewMode_Change_Together()
    {
    ...
    [Fact]
    public void GanttChart_Does_Not_Recenter_When_Neither_Tasks_Mode_Nor_ColumnWidth_Change()
    {
