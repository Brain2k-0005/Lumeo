...
internal static partial class LumeoDefaultStrings
{
    internal static readonly IReadOnlyDictionary<string, string> Pl = new Dictionary<string, string>
    {
        ...
        ["Scheduler.Previous"] = "Poprzednia",
        ["Scheduler.Next"] = "Następna",
        ["Scheduler.ResourceLegend"] = "Legenda zasobów",
        ["Scheduler.Day"] = "Dzień",
        ["Scheduler.Week"] = "Tydzień",
        ["Scheduler.Month"] = "Miesiąc",
        ["Scheduler.List"] = "Lista",
        ["Scheduler.Today"] = "Dziś",
        ["Scheduler.WeekOf"] = "Tydzień od {0}",
        ...
        ["Gantt.Year"] = "Rok",
        ["Gantt.Today"] = "Dziś",
        ["Gantt.PreviousPeriod"] = "Poprzedni okres",
        ["Gantt.NextPeriod"] = "Następny okres",
        ["Gantt.ExpandRow"] = "Rozwiń {0}",
        ["Gantt.CollapseRow"] = "Zwiń {0}",
        ["Gantt.NewTask"] = "Nowe zadanie",
