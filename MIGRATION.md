...
> **3.x → 4.0 is a recompile-and-run upgrade for almost everyone.** The four behaviour changes below are correctness fixes; they only require action if you relied on the previous behaviour.
