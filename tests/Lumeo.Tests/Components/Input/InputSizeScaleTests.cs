...
/// The Md rows moved in the 5.0 scale alignment - shadcn's input is h-8 px-2.5, measured in
/// a project built with their CLI. Only that rung moved; the rest of the ladder is as it was,
/// which is why the diff here is six lines and not the whole table.
public class InputSizeScaleTests : IAsyncLifetime
{
    ...
    [InlineData(L.Size.Sm, L.Density.Comfortable, "h-[var(--lumeo-control-h,calc(var(--spacing,0.25rem)*8))]")]
    [InlineData(L.Size.Md, L.Density.Comfortable, "h-[var(--lumeo-control-h,calc(var(--spacing,0.25rem)*8))]")]
    ...
    [InlineData(L.Size.Md, L.Density.Compact, "h-7")]
    ...
    [InlineData(L.Size.Md, L.Density.Spacious, "h-9")]
    ...
    [InlineData(L.Size.Md, L.Density.Comfortable, "px-2.5")]
    ...
    [InlineData(L.Size.Md, L.Density.Compact, "px-2")]
    ...
    [InlineData(L.Size.Md, L.Density.Spacious, "px-3")]
