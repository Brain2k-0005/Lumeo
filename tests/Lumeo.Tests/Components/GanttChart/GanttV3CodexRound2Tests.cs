...
/// scroll-to-today gate (finding #8, "visual snapshot drift"), and GanttChart's
...
public class GanttV3CodexRound2Tests : IAsyncLifetime
{
    ...
    public void GanttTimeline_Reattempts_The_Scroll_When_The_Today_Parameter_Changes_After_Mount()
    {
        ...
        // GanttChart's browser-date resolution can land a render or two after
    ...
    // ── GanttChart: browser-local "today" resolution (finding #9) ───────────────

    [Fact]
    public void GanttChart_Resolves_The_Browsers_Local_Date_And_Uses_It_For_The_Initial_Range()
    {
        // The empty-task-list fallback branch of ComputeInitialRange is the
        // most direct, deterministic way to observe WHICH "today" GanttChart
    ...
    [Fact]
    public void GanttChart_Falls_Back_To_Server_DateTime_Today_When_Interop_Is_Unavailable()
    {
