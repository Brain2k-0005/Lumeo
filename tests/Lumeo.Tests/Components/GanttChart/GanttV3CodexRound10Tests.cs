...
public class GanttV3CodexRound10Tests : IAsyncLifetime
{
    ...
    // ── GanttChart: parent-driven ViewMode change must recenter too (P2 #2) ─────

    [Fact]
    public void GanttChart_Recenters_Preserving_The_Live_Center_When_The_ViewMode_Parameter_Changes_On_A_Mounted_Chart()
    {
    ...
    // ── GanttChart: ShowTreePane default must use the filtered task set (P2 #3) ─

    [Fact]
    public void GanttChart_Does_Not_Show_The_Tree_Pane_When_The_Only_ParentId_Task_Is_Filtered_Out_As_Invalid()
    {
        ...
        // EffectiveShowTreePane is false (the @if block in GanttChart's markup
    ...
    // ── GanttChart.GoToTodayAsync: Month/Year recenter preserves column count (P2 #4) ─
