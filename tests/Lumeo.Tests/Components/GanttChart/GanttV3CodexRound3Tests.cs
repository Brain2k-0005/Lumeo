...
public class GanttV3CodexRound3Tests : IAsyncLifetime
{
    ...
    public void GanttTimeline_Drops_Its_Own_Horizontal_Scroll_And_Skips_Header_Sync_Registration_When_ScrollHost_Is_Supplied()
    {
        ...
        // mode — a caller-supplied @ref (like GanttChart's own outer pane) is
    ...
    public void GanttTimeline_Keeps_Its_Prior_Self_Contained_Behavior_When_ScrollHost_Is_Not_Supplied()
    {
        ...
        // renders GanttTimeline alone, with no GanttChart wrapping it) must be
    ...
    // ── GanttChart: recenter on empty→populated (finding #2) ────────────────────

    [Fact]
    public void GanttChart_Rerequests_The_Initial_Scroll_When_An_Empty_Task_List_Is_Later_Populated()
    {
    ...
    [Fact]
    public void GanttChart_Does_Not_Rerequest_The_Scroll_When_An_Already_Populated_Task_List_Changes()
    {
    ...
    // ── GanttChart: Today-recenter unit alignment (finding #6) ──────────────────

    [Fact]
    public void GanttChart_GoToTodayAsync_In_Month_Mode_Aligns_The_Origin_So_Bar_Pixels_Match_DateToPixel_Ground_Truth()
    {
        ...
        // (GanttChart.razor's own remarks) independently of the fix, to compute
