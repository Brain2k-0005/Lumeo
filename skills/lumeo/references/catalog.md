...
- **Scheduler** **[Scheduler]** — Calendar and agenda scheduler with month, week, day, agenda, resource and timeline views. _(sub-components: SchedulerAgendaView, SchedulerMonthView, SchedulerResourceView, SchedulerTimeGridView, SchedulerToolbar)_
