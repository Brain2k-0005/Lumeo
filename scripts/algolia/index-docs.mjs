...
const extras = [
    ...
    },
    {
        ...
        url: '/blocks/authentication',
        category: 'Patterns',
        summary: "shadcn's Authentication example: a split page with a brand panel and an email sign-in form.",
    },
    {
        id: 'pattern:calendar',
        type: 'pattern',
    ...
    },
    {
        ...
        url: '/blocks/mail',
        category: 'Patterns',
        summary: "shadcn's Mail example: a resizable three-pane inbox with a collapsible folder nav and a reading pane.",
    },
    {
        id: 'pattern:music',
        type: 'pattern',
        ...
        url: '/blocks/music',
        category: 'Patterns',
        summary: "shadcn's Music example: a menubar, a library sidebar, album rows with a context menu.",
    },
    {
        id: 'pattern:notifications',
        type: 'pattern',
        title: 'Notifications',
        url: '/blocks/notifications',
        category: 'Patterns',
