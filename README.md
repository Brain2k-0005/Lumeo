...
> **v2.0 is in release-candidate phase (latest: `2.0.0-rc.37`).** The API is stable; we're gathering field feedback before tagging `2.0.0` final. See [`MIGRATION.md`](./MIGRATION.md) for upgrade notes from 1.x.
...
```xml
<ItemGroup>
  <PackageReference Include="Lumeo"            Version="2.0.0-rc.37" />
  <!-- add only the satellites you need: -->
  <PackageReference Include="Lumeo.Charts"    Version="2.0.0-rc.37" />
  <PackageReference Include="Lumeo.DataGrid"  Version="2.0.0-rc.37" />
  <PackageReference Include="Lumeo.Editor"    Version="2.0.0-rc.37" />
  <PackageReference Include="Lumeo.Scheduler" Version="2.0.0-rc.37" />
  <PackageReference Include="Lumeo.Gantt"     Version="2.0.0-rc.37" />
  <PackageReference Include="Lumeo.Motion"    Version="2.0.0-rc.37" />
</ItemGroup>
```
