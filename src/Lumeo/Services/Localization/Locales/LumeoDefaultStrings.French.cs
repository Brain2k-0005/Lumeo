...
internal static partial class LumeoDefaultStrings
{
    internal static readonly IReadOnlyDictionary<string, string> Fr = new Dictionary<string, string>
    {
        ...
        ["DataGrid.AutoSizeAllColumns"] = "Ajuster automatiquement toutes les colonnes",
        ...
        // ── IconPicker ────────────────────────────────
        ["IconPicker.Placeholder"] = "Choisir une icône",
        ["IconPicker.SearchPlaceholder"] = "Rechercher des icônes",
        ["IconPicker.NoIconsFound"] = "Aucune icône trouvée",
        ...
        ["Flow.CanvasLabel"] = "Canevas de flux",
        ["Flow.NodeRole"] = "nœud",
        ["Flow.Controls"] = "Commandes du canevas",
        ["Flow.ZoomIn"] = "Zoomer",
        ["Flow.ZoomOut"] = "Dézoomer",
        ["Flow.FitView"] = "Ajuster la vue",
        ["Flow.Lock"] = "Verrouiller le canevas",
        ["Flow.ConnectFrom"] = "Connecter depuis {0}",
        ["Flow.ConnectTo"] = "Connecter à {0}",
        ["Flow.MiniMap"] = "Aperçu",
        ["Flow.NodeToolbar"] = "Actions du nœud",
        ["Flow.SnapToGrid"] = "Aligner sur la grille",
        ["Flow.Undo"] = "Annuler",
        ["Flow.Redo"] = "Rétablir",
        ["Flow.ReconnectHandle"] = "Déplacer l'extrémité de l'arête",
        ["Flow.ConnectingFrom"] = "Connexion depuis {0}. Appuyez sur Entrée sur un point cible pour connecter, Échap pour annuler.",
        ["Flow.Connected"] = "Connecté.",
        ["Flow.ConnectionRejected"] = "Connexion refusée.",
        ...
        ["Flow.GroupDefaultLabel"] = "Groupe",
        ["Flow.GroupRole"] = "groupe",
        ["Flow.GroupChildCountOne"] = "1 nœud",
        ["Flow.GroupChildCount"] = "{0} nœuds",
        ["Flow.Grouped"] = "{0} nœuds groupés.",
        ["Flow.Ungrouped"] = "{0} nœuds dégroupés.",
